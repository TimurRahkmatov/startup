...
const StartupCard = () => {
  return (
    ...
    >
      <div className="container px-7 flex gap-8">
        <div
          style={{
            width: "320px",
            height: "320px",
        ...
        >
          <div>
            <img src={SpendImage} style={{width: "65x" , height: "65px"}} alt="" />
        ...
        >
          <div>
            <img src={InImg} style={{width: "60px" , height: "60px"}} alt="" />
        ...
        >
          <div>
            <img src={DemaloImg} style={{width: "60px" , height: "60px"}} alt="" />
